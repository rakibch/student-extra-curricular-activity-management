                ...
                <div class="basic-form">
                    <form id="profilePictureForm">
                        ...
                        <div class="form-group">
                            ...
                            <input name="student_id" value="{{$getProfileDetails->student_id ?? ''}}" id="student_id" type="text" class="form-control" placeholder="Type your student id">
                        </div>
                        <div class="form-group">
                            <label>Phone</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" value="{{$getProfileDetails->date_of_birth ?? ''}}" name="dob" id="date_of_birth" class="form-control" placeholder="Type your date">
                        </div>
                        <div class="form-group">
                            <div class="form-group">
                                    <label>Gender</label>
