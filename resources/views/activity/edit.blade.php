                            ...
                            <div class="basic-form">
                                <form id="profilePictureForm">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$getActivityDetails->activity_name}}" name="acitivity_name" id="acitivity_name"
                                            class="form-control" placeholder="Type activity title">
                                    </div>
                                    <div class="form-group">
                                        <label>Activity Location</label>
                                        <input type="activity_location" name="activity_location" value="{{$getActivityDetails->activity_location}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="activity_description" id="activity_description"
                                            class="form-control">{{$getActivityDetails->activity_description}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Start Date</label>
                                        <input type="date" value="{{$getActivityDetails->start_date}}" name="start_date" id="start_date"
                                            class="form-control" placeholder="Type start date">
                                        <input type="hidden" value="{{$getActivityDetails->userInfo->id}}" id="userId">
                                        <input type="hidden" value="{{$getActivityDetails->id}}" id="activityId">
                                        </div>
                                    <div class="form-group">
                                        <label>End Date</label>
                                        <input type="date" value="{{$getActivityDetails->end_date}}" name="end_date" id="end_date" class="form-control"
                                            placeholder="Type end date">
                                    </div>
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label>Created By</label>
                                            <input disabled name="created_by" value="{{$getActivityDetails->userInfo->name}}"
                                            id="created_by" type="text" class="form-control"
                                            placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('storage/uploads/'.$getActivityDetails->activity_image) }}" style="max-width: 200px;" id="activityImage">
                                    </div>
